...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input"
                   lay-verify="required" name="dataDicName" id="dataDicName" value="${(DataDic.dataDicName)!}"
                   placeholder="请输数据类型">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input"
                   lay-verify="required" name="dataDicValue" id="dataDicValue" value="${(DataDic.dataDicValue)!}"
                   placeholder="请输入数据值">
        </div>
    </div>
